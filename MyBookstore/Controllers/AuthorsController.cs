...
namespace MyBookstore.Controllers
{
    public class AuthorsController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            {
                con.Open();
                string query = @"SELECT authorID, authorLN, authorFN, authorPhone, authorAddress, authorCity, authorState, authorZip
                                FROM authors";
        ...
        public ActionResult Edit(int? id)
        {
            ...
            {
                con.Open();
                string query = @"SELECT authorLN, authorFN, authorPhone, authorAddress, authorCity, authorState, authorZip
        ...
        public ActionResult Edit(AuthorsModels author)
        {
            ...
            using (SqlConnection con = new SqlConnection(Helper.GetCon()))
            {
                ...
                string query = @"UPDATE authors SET authorLN=@authorLN, authorFN=@authorFN, authorPhone=@authorPhone,
                        authorAddress=@authorAddress, authorCity=@authorCity, authorState=@authorState, authorZip=@authorZip
